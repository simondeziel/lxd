...
func (d *lvm) createLogicalVolume(vgName, thinPoolName string, vol Volume, makeThinLv bool) error {
	...
	if isRecent {
		...
		_, err := shared.RunCommandContext(context.TODO(), "lvchange", "--setactivationskip", "y", volPath)
		if err != nil {
...
func (d *lvm) activateVolume(vol Volume) (bool, error) {
	...
	_, err := shared.RunCommandContext(context.TODO(), "lvchange", "--activate", "y", "--ignoreactivationskip", volPath)
	if err != nil {
...
func (d *lvm) deactivateVolume(vol Volume) (bool, error) {
	...
	_, err = shared.TryRunCommand("lvchange", "--activate", "n", "--ignoreactivationskip", volPath)
	if err != nil {
